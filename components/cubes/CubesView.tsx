    ...
    <button
      ...
      className={`inline-flex items-center gap-1.5 rounded-full border px-3 py-1.5 text-xs font-bold transition-colors [touch-action:manipulation] ${
        active
          ...
          : "border-white/20 text-token-muted hover:bg-white/10"
      }`}
    >
      {children}
    </button>
      ...
      {showForm && (
        <form action={action} className="sticker rounded-xl border border-white/10 bg-white/5 p-4 space-y-3">
          ...
          <div className="space-y-1">
            ...
            <Input id="name" name="name" required placeholder="RS3M 2020" className="bg-white/10 border-white/20" />
          </div>

          <div className="grid grid-cols-2 gap-2">
            <div className="space-y-1">
              <Label htmlFor="brand" className="text-xs font-bold uppercase text-white/60">Brand</Label>
              <Input id="brand" name="brand" placeholder="MoYu" className="bg-white/10 border-white/20" />
            </div>
            <div className="space-y-1">
              <Label htmlFor="event_id" className="text-xs font-bold uppercase text-white/60">Event</Label>
              <select id="event_id" name="event_id" className={`${nativeSelectClass} bg-white/10 border-white/20`}>
          ...
          <div className="space-y-1">
            ...
            <Input id="photo" name="photo" type="file" accept="image/*" className="bg-white/10 border-white/20 file:bg-white/10 file:border-0 file:font-bold" />
          </div>
              ...
              >
                ...
                <div className="grid grid-cols-2 gap-2">
                  ...
                  <div className="space-y-1">
                    ...
                    <select
                      ...
                      className={`${nativeSelectClass} bg-white/10 border-white/20`}
                    >
                      <option value="">General</option>
                      {events.map((e) => (
                        <option key={e.id} value={e.id}>
                ...
                <div className="space-y-1">
                  ...
                  <Input
                    ...
                    className="bg-white/10 border-white/20 file:bg-white/10 file:border-0 file:font-bold"
                  />
                </div>
